...
supervisor_agent = Agent(
    ...
    backstory="""You are a senior travel advisor who specializes in creating comprehensive 
    travel reports. You analyze and organize information from various travel experts to 
    create clear, well-structured travel advisory reports.""",
    tools=[search_tool],
    verbose=True,
    llm=llm
)
...
def main():
    ...
    has_insurance = input("Do you already have health insurance that covers your travel needs? (yes/no): ").lower()
    ...
    print(f"\nReport has been saved to: {saved_file}")
    print("\nFinal Travel Advisory Report Preview:")
    print("============================")
    print(final_report)
    
    return final_report, saved_file

if __name__ == "__main__":
    result, filepath = main()
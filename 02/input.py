...
# Create a task for content planning
plan = Task(
    description=(
...
# Create a task for writing the blog post
write = Task(
    description=(
...
# Create a task for editing the blog post
edit = Task(
    ...
    expected_output="A well-written blog post in markdown format, "
                    ...
                    "each section should have 2 or 3 paragraphs.",
    agent=editor,
    output_file="outputs/edited_blog_post.md",
...
crew = Crew(
    ...
    output_log_file="editing_log.txt" # Log file for tracking the editing process
